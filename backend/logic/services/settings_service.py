from backend.database.crud.user_crud import UserCrud, LoginPasswordVerify
...
class SettingsService():
    def update_login(self, data):
        ...
        if salt:
            ...
            updated_info = UpdateLoginRequest(login=data.login,
    ...
    def update_password(self, data):
        ...
        if salt:
            ...
            updated_info = UpdatePasswordRequestToDB(login=data.login,
                                                password=hashed_password,
    ...
    def update_email(self, data):
        ...
        if salt:
            ...
            updated_info = UpdateEmailRequest(login=data.login,
                                            password=hashed_password,
    ...
    def delete_account(self, data):
        ...
        if salt:
            ...
            updated_info = DeleteProfileRequest(login=data.login,
                                            password=hashed_password,
            )
