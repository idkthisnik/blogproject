...
def change_login(data: UpdateLoginRequest):
...
def change_password(data: UpdatePasswordRequest):
...
def change_email(data: UpdateEmailRequest):
...
def delete_profile(data: DeleteProfileRequest):
